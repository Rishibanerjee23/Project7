...
entranceHall['items'].append("flashlight")
entranceHall['items'].append("dog")
entranceHall['items'].append(front_door_key)
...
create_exit(entranceHall, "kitchen", "There is a red door.",hidden=True)
